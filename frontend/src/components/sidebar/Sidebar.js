...
export default function Sidebar() {
  ...
  useEffect(() => {
    const getCats = async () => {
      const res = await axios.get("https://blogify-vxjr.onrender.com/api/categories");
      setCats(res.data);
    };
    getCats();
  }, []);
      ...
      <div className="sidebarItem">
        ...
        <div className="sidebarSocial">
          ...
          <i className="sidebarIcon fab fa-pinterest-square"></i>
            ...
            <a href="https://www.instagram.com/ashutosh_mishraa_0?igsh=eGhkaWhjcGE2YTRy"><i className="sidebarIcon fab fa-instagram-square"></i></a>
